...
const {wishlistLength } = useContext(ContextData);
  ...
  >
    ...
    <div className="tp-header-login-content d-none d-xl-block">
                ...
                <div className="tp-header-action d-flex align-items-center ml-50">
                  ...
                  <div className="tp-header-action-item d-none d-lg-block">
                    <Link to={WishlistPath}  className="tp-header-action-btn">
                      ...
                      <span className="tp-header-action-badge">{wishlistLength}</span>                          
                    </Link>
                  </div>
     ...
     <svg style={{color:'white'}} width="22" height="19" viewBox="0 0 22 19" fill="none" xmlns="http://www.w3.org/2000/svg">
