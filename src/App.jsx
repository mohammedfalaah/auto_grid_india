    ...
    <section className="tp-slider-area p-relative z-index-1">
      <Carousel>
        ...
        <Carousel.Item interval={1000}>
          <img style={{ width: '100%' }} src="/assets/img/slider/3-1.jpg" alt="Slide 1" />
        ...
        <Carousel.Item interval={500}>
          <img style={{ width: '100%' }} src="/assets/img/slider/5-2.jpg" alt="Slide 2" />
          {/* 
          <Carousel.Caption>
        ...
        <Carousel.Item interval={1500}>
          <img style={{ width: '100%' }} src="/assets/img/slider/WhatsApp-Image-2024-01-04-at-6.20.00-PM.jpeg" alt="Slide 3" />
          {/* 
          <Carousel.Caption>
        ...
        {/* Fourth Slide */}
        <Carousel.Item interval={1000}>
          <img style={{ width: '100%' }} src="/assets/img/slider/7-2.jpg" alt="Slide 4" />
          {/* 
          <Carousel.Caption>
        ...
        <Carousel.Item interval={1000}>
          <img style={{ width: '100%' }} src="/assets/img/slider/6.jpg" alt="Slide 4" />
          {/* 
          <Carousel.Caption>
            <h3>Fourth slide label</h3>
            <p>Nulla vitae elit libero, a pharetra augue mollis interdum.</p>
        ...
        <Carousel.Item interval={1000}>
          <img style={{ width: '100%' }} src="/assets/img/slider/4.jpg" alt="Slide 4" />
          {/* 
          <Carousel.Caption>
            <h3>Fourth slide label</h3>
            <p>Nulla vitae elit libero, a pharetra augue mollis interdum.</p>
        ...
        <div className="row align-items-end">
          <div className="col-xl-5 col-lg-6 col-md-5">
            <div className="tp-section-title-wrapper mb-40">
              <h3 className="tp-section-title"> Products 
                  ...
                  <div className="row">
                    <div className="col-xl-3 col-lg-3 col-sm-6">
                      <div className="tp-product-item p-relative transition-3 mb-25">
                        <div className="tp-product-thumb p-relative fix m-img">
                          <a href="product-details.html">
                            <img src="/public/assets/img/product/Hh_0005_IMG_4804-600x600.jpg" alt="product-electronic" />
                          </a>
                          {/* product badge */}
                    ...
                    <div className="col-xl-3 col-lg-3 col-sm-6">
                      <div className="tp-product-item transition-3 mb-25">
                        <div className="tp-product-thumb p-relative fix m-img">
                          <a href="product-details.html">
                            <img src="/public/assets/img/product/Hh_0004_IMG_4805-600x600.jpg" alt="product-electronic" />
                          </a>
                          {/* product badge */}
                          <div className="tp-product-badge">
                    ...
                    <div className="col-xl-3 col-lg-3 col-sm-6">
                      <div className="tp-product-item transition-3 mb-25">
                        <div className="tp-product-thumb p-relative fix m-img">
                          <a href="product-details.html">
                            <img src="/public/assets/img/product/bike-11-600x600.png" alt="product-electronic" />
                          </a>
                          {/* product badge */}
                          <div className="tp-product-badge">
                    ...
                    <div className="col-xl-3 col-lg-3 col-sm-6">
                      <div className="tp-product-item transition-3 mb-25">
                        <div className="tp-product-thumb p-relative fix m-img">
                          <a href="product-details.html">
                            <img src="/public/assets/img/product/iPhone_06310_IMG_0146_0014_iPhone_06310_IMG_0143-600x600.jpg" alt="product-electronic" />
                          </a>
                          {/* product action */}
                          <div className="tp-product-action">
                            <div className="tp-product-action-item d-flex flex-column">
                    ...
                    <div className="col-xl-3 col-lg-3 col-sm-6">
                      <div className="tp-product-item transition-3 mb-25">
                        <div className="tp-product-thumb p-relative fix m-img">
                          <a href="product-details.html">
                            <img src="/public/assets/img/product/frameee-600x600.jpg" alt="product-electronic" />
                          </a>
                          {/* product badge */}
                          <div className="tp-product-badge">
                            <span className="product-trending">Trending</span>
                    ...
                    <div className="col-xl-3 col-lg-3 col-sm-6">
                      <div className="tp-product-item transition-3 mb-25">
                        <div className="tp-product-thumb p-relative fix m-img">
                          <a href="product-details.html">
                            <img src="/public/assets/img/product/12-1-300x300.jpg" alt="product-electronic" />
                          </a>
                          {/* product action */}
                          <div className="tp-product-action">
                            <div className="tp-product-action-item d-flex flex-column">
                    ...
                    <div className="col-xl-3 col-lg-3 col-sm-6">
                      <div className="tp-product-item transition-3 mb-25">
                        <div className="tp-product-thumb p-relative fix m-img">
                          <a href="product-details.html">
                            <img src="/public/assets/img/product/iPhone_06310_IMG_0146_0004_iPhone_06310_IMG_0138-600x600.jpg" alt="product-electronic" />
                          </a>
                          {/* product badge */}
                          <div className="tp-product-badge">
                    ...
                    <div className="col-xl-3 col-lg-3 col-sm-6">
                      <div className="tp-product-item transition-3 mb-25">
                        <div className="tp-product-thumb p-relative fix m-img">
                          <a href="product-details.html">
                            <img src="/public/assets/img/product/iPhone_06310_IMG_0146_0002_iPhone_06310_IMG_0153-600x600.jpg" alt="product-electronic" />
                          </a>
                          {/* product badge */}
                          <div className="tp-product-badge">
                            <span className="product-hot">Hot</span>
        ...
        <div className="row row-cols-lg-5 row-cols-md-3 row-cols-sm-2 row-cols-1">
          ...
          <div className="col">
            <div className="tp-instagram-item p-relative z-index-1 fix mb-30 w-img">
              ...
              <div className="tp-instagram-icon">
                <a href="https://www.instagram.com/p/C4nlAP-hOJ8/?igsh=MWRra2gzMjVra2ZhMw%3D%3D" className="popup-image"><i className="fa-brands fa-instagram" /></a>
              </div>
            </div>
          </div>
          <div className="col">
