                ...
                <div className="col-xl-5 col-lg-6 col-md-6">
                  <div className="tp-slider-content p-relative z-index-1">
                    ...
                    <div className="tp-slider-btn">
                      <a href="shop.html" className="tp-btn tp-btn-2 tp-btn-white">Shop Now
        ...
        <div className="row align-items-end">
          <div className="col-xl-5 col-lg-6 col-md-5">
            <div className="tp-section-title-wrapper mb-40">
              <h3 className="tp-section-title">Trending Products 
            ...
            <div className="tp-product-tab tp-product-tab-border mb-45 tp-tab d-flex justify-content-md-end">
              <ul className="nav nav-tabs justify-content-sm-end" id="productTab" role="tablist">
                <li className="nav-item" role="presentation">
                  <button className="nav-link active" id="new-tab" data-bs-toggle="tab" data-bs-target="#new-tab-pane" type="button" role="tab" aria-controls="new-tab-pane" aria-selected="true">New
                ...
                <li className="nav-item" role="presentation">
                  <button className="nav-link" id="featured-tab" data-bs-toggle="tab" data-bs-target="#featured-tab-pane" type="button" role="tab" aria-controls="featured-tab-pane" aria-selected="false">Featured
                    <span className="tp-product-tab-line">
                      <svg width={52} height={13} viewBox="0 0 52 13" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M1 8.97127C11.6061 -5.48521 33 3.99996 51 11.4635" stroke="currentColor" strokeWidth={2} strokeMiterlimit="3.8637" strokeLinecap="round" />
                      </svg>
                ...
                <li className="nav-item" role="presentation">
                  <button className="nav-link" id="topsell-tab" data-bs-toggle="tab" data-bs-target="#topsell-tab-pane" type="button" role="tab" aria-controls="topsell-tab-pane" aria-selected="false">Top Sellers
                    <span className="tp-product-tab-line">
                      <svg width={52} height={13} viewBox="0 0 52 13" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M1 8.97127C11.6061 -5.48521 33 3.99996 51 11.4635" stroke="currentColor" strokeWidth={2} strokeMiterlimit="3.8637" strokeLinecap="round" />
                      </svg>
            ...
            <div className="tp-banner-item tp-banner-height p-relative mb-30 z-index-1 fix">
              ...
              <div className="tp-banner-content">
                ...
                <div className="tp-banner-btn">
                  <a href="product-details.html" className="tp-link-btn">Shop Now 
      ...
      <div className="container">
        <div className="row align-items-end">
          <div className="col-xl-4 col-md-5 col-sm-6">
            <div className="tp-section-title-wrapper mb-40">
              <h3 className="tp-section-title">Deal of The Day
                <svg width={114} height={35} viewBox="0 0 114 35" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path d="M112 23.275C1.84952 -10.6834 -7.36586 1.48086 7.50443 32.9053" stroke="currentColor" strokeWidth={4} strokeMiterlimit="3.8637" strokeLinecap="round" />
                </svg>
              </h3>
          ...
          <div className="col-xl-8 col-md-7 col-sm-6">
            <div className="tp-product-offer-more-wrapper d-flex justify-content-sm-end p-relative z-index-1">
              <div className="tp-product-offer-more mb-40 text-sm-end grey-bg-2">
                <a href="shop.html" className="tp-btn tp-btn-2 tp-btn-blue">View All Deals 
                  <svg width={17} height={14} viewBox="0 0 17 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M16 6.99976L1 6.99976" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                    <path d="M9.9502 0.975414L16.0002 6.99941L9.9502 13.0244" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                  </svg>
                </a>
                <span className="tp-product-offer-more-border" />
              </div>
            </div>
          </div>
        </div>
        <div className="row">
          <div className="col-xl-12">
            <div className="tp-product-offer-slider fix">
              <div className="tp-product-offer-slider-active swiper-container">
                <div className="swiper-wrapper">
                  <div className="tp-product-offer-item tp-product-item transition-3 swiper-slide">
                    <div className="tp-product-thumb p-relative fix m-img">
                      <a href="product-details.html">
                      ...
                      <div className="tp-product-action">
                        <div className="tp-product-action-item d-flex flex-column">
                          <button type="button" className="tp-product-action-btn tp-product-compare-btn">
                            ...
                            <span className="tp-product-tooltip">Compare</span>
                          </button>
                          <button type="button" className="tp-product-action-btn tp-product-quick-view-btn" data-bs-toggle="modal" data-bs-target="#producQuickViewModal">
                            <svg width={20} height={17} viewBox="0 0 20 17" fill="none" xmlns="http://www.w3.org/2000/svg">
                              <path fillRule="evenodd" clipRule="evenodd" d="M9.99938 5.64111C8.66938 5.64111 7.58838 6.72311 7.58838 8.05311C7.58838 9.38211 8.66938 10.4631 9.99938 10.4631C11.3294 10.4631 12.4114 9.38211 12.4114 8.05311C12.4114 6.72311 11.3294 5.64111 9.99938 5.64111ZM9.99938 11.9631C7.84238 11.9631 6.08838 10.2091 6.08838 8.05311C6.08838 5.89611 7.84238 4.14111 9.99938 4.14111C12.1564 4.14111 13.9114 5.89611 13.9114 8.05311C13.9114 10.2091 12.1564 11.9631 9.99938 11.9631Z" fill="currentColor" />
                ...
                <div className="tp-deals-slider-dot tp-swiper-dot text-center mt-40" />
              </div>
            </div>
          </div>
        </div>
            ...
            <div className="tp-product-gadget-sidebar mb-40">
              <div className="tp-product-gadget-categories p-relative fix mb-10">
                ...
                <div className="tp-product-gadget-btn">
                  <a href="shop-category.html" className="tp-link-btn">More Products 
                    <svg width={15} height={13} viewBox="0 0 15 13" fill="none" xmlns="http://www.w3.org/2000/svg">
                      <path d="M13.9998 6.19656L1 6.19656" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                      <path d="M8.75674 0.975394L14 6.19613L8.75674 11.4177" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                    </svg>
                ...
                <div className="col-xl-4 col-sm-6">
                  <div className="tp-product-item p-relative transition-3 mb-25">
                    ...
                    <div className="tp-product-content">
                      ...
                      <div className="tp-product-price-wrapper">
                        <span className="tp-product-price old-price">$135.00</span>
                        <span className="tp-product-price new-price">$114.00</span>
                      </div>
                    </div>
                  </div>
                </div>
                <div className="col-xl-4 col-sm-6">
                  <div className="tp-product-item p-relative transition-3 mb-25">
                    ...
                    <div className="tp-product-content">
                      ...
                      <div className="tp-product-price-wrapper">
                        <span className="tp-product-price">$40.00</span>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div className="swiper-wrapper">
                  <div className="tp-product-item transition-3 mb-25 swiper-slide">
                    ...
                    <div className="tp-product-content">
                      ...
                      <div className="tp-product-price-wrapper">
                        <span className="tp-product-price old-price">$475.00</span>
                        <span className="tp-product-price new-price">$7350.00</span>
                      </div>
                    </div>
                  </div>
                  <div className="tp-product-item transition-3 mb-25 swiper-slide ">
                    ...
                    <div className="tp-product-content">
                      ...
                      <div className="tp-product-price-wrapper">
                        <span className="tp-product-price old-price">$140.00</span>
                        <span className="tp-product-price new-price">$120.00</span>
                      </div>
                    </div>
                  </div>
              ...
              <div className="tp-section-title-wrapper mb-40">
                <h3 className="tp-section-title tp-section-title-sm">Discount Products
                  <svg width={64} height={20} viewBox="0 0 64 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M62 13.1107C1.91792 -5.41202 -3.10865 1.22305 5.00242 18.3636" stroke="currentColor" strokeWidth={3} strokeMiterlimit="3.8637" strokeLinecap="round" />
                  </svg>                                 
                </h3>
              </div>
              <div className="tp-product-sm-wrapper mr-20">
                <div className="tp-product-sm-item d-flex align-items-center">
                  ...
                  <div className="tp-product-sm-content">
                    ...
                    <div className="tp-product-price-wrapper">
                      <span className="tp-product-price">$97.00</span>
                    </div>
                  </div>
                </div>
                <div className="tp-product-sm-item d-flex align-items-center">
              ...
              <div className="tp-product-sm-wrapper mr-20">
                <div className="tp-product-sm-item d-flex align-items-center">
                  ...
                  <div className="tp-product-sm-content">
                    ...
                    <div className="tp-product-price-wrapper">
                      <span className="tp-product-price">$12.00</span>
                    </div>
                  </div>
                </div>
                <div className="tp-product-sm-item d-flex align-items-center">
                  ...
                  <div className="tp-product-sm-content">
                    ...
                    <div className="tp-product-price-wrapper">
                      <span className="tp-product-price">$84.00</span>
                    </div>
                  </div>
                </div>
                <div className="tp-product-sm-item d-flex align-items-center">
                  ...
                  <div className="tp-product-sm-content">
                    ...
                    <div className="tp-product-price-wrapper">
                      <span className="tp-product-price">$120.00</span>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="tp-product-sm-wrapper mr-20">
                <div className="tp-product-sm-item d-flex align-items-center">
                  ...
                  <div className="tp-product-sm-content">
                    ...
                    <div className="tp-product-price-wrapper">
                      <span className="tp-product-price">$102.00</span>
                    </div>
                  </div>
                </div>
                <div className="tp-product-sm-item d-flex align-items-center">
                  ...
                  <div className="tp-product-sm-content">
                    ...
                    <div className="tp-product-price-wrapper">
                      <span className="tp-product-price">$59.00</span>
                    </div>
                  </div>
                </div>
                <div className="tp-product-sm-item d-flex align-items-center">
                  ...
                  <div className="tp-product-sm-content">
                    ...
                    <div className="tp-product-price-wrapper">
                      <span className="tp-product-price">$356.00</span>
                    </div>
                  </div>
                </div>
              </div>
          ...
          <div className="col-xl-8 col-md-6">
            <div className="tp-blog-more-wrapper d-flex justify-content-md-end">
              <div className="tp-blog-more mb-50 text-md-end">
                <a href="blog-grid.html" className="tp-btn tp-btn-2 tp-btn-blue">View All Blog 
                  <svg width={17} height={14} viewBox="0 0 17 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M16 6.99976L1 6.99976" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                    <path d="M9.9502 0.975414L16.0002 6.99941L9.9502 13.0244" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                  </svg>
                  ...
                  <div className="tp-blog-item mb-30 swiper-slide">
                    ...
                    <div className="tp-blog-content">
                      ...
                      <div className="tp-blog-tag">
                        <span><i className="fa-light fa-tag" /></span>
                        <a href="#">Tablet,</a>
                        <a href="#">News</a>
                      </div>
          ...
          <div className="col">
            <div className="tp-instagram-item p-relative z-index-1 fix mb-30 w-img">
              ...
              <div className="tp-instagram-icon">
                <a href="assets/img/instagram/instagram-1.jpg" className="popup-image"><i className="fa-brands fa-instagram" /></a>
              </div>
            </div>
          </div>
          <div className="col">
            <div className="tp-instagram-item p-relative z-index-1 fix mb-30 w-img">
              ...
              <div className="tp-instagram-icon">
                <a href="assets/img/instagram/instagram-2.jpg" className="popup-image"><i className="fa-brands fa-instagram" /></a>
              </div>
            </div>
          </div>
          <div className="col">
            <div className="tp-instagram-item p-relative z-index-1 fix mb-30 w-img">
              ...
              <div className="tp-instagram-icon">
                <a href="assets/img/instagram/instagram-3.jpg" className="popup-image"><i className="fa-brands fa-instagram" /></a>
              </div>
            </div>
          </div>
          <div className="col">
            <div className="tp-instagram-item p-relative z-index-1 fix mb-30 w-img">
              ...
              <div className="tp-instagram-icon">
                <a href="assets/img/instagram/instagram-4.jpg" className="popup-image"><i className="fa-brands fa-instagram" /></a>
              </div>
            </div>
          </div>
          <div className="col">
            <div className="tp-instagram-item p-relative z-index-1 fix mb-30 w-img">
              ...
              <div className="tp-instagram-icon">
                <a href="assets/img/instagram/instagram-5.jpg" className="popup-image"><i className="fa-brands fa-instagram" /></a>
              </div>
            </div>
          </div>
        </div>
