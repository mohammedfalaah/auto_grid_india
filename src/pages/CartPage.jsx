              ...
              <tbody>
                ...
                <tr key={product.cartId}>
                  ...
                  <td className="tp-cart-img"><a href="product-details.html"> 
                    <img src={`https://node.autogridnumberplate.com${product.image}`} alt={product.name} /></a></td>
                  {/* title */}
                  <td className="tp-cart-title"><a href="product-details.html">{product.name}</a></td>
                  {/* price */}
                  <td className="tp-cart-price"><span>{product.price}</span></td>
                  {/* quantity */}
