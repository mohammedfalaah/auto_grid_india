          ...
          <div className="tp-shop-main-wrapper">
            ...
            <div className="tp-shop-items-wrapper tp-shop-item-primary">
              <div className="tab-content" >
                ...
                <div className="tab-pane fade show active" id="list-tab-pane" role="tabpanel" aria-labelledby="list-tab" tabIndex={0}>
                      ...
                      <div className="col-xl-12">
                        ...
                        <div className="tp-product-list-item d-md-flex">                      
                          <div className="tp-product-list-thumb p-relative fix">
                              ...
                              <img style={{width:'218px'}}src={product.photographs?.[0] || ""} alt={product.productName} />
