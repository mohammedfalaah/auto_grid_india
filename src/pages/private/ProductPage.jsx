  ...
  <div className="tp-filter-offcanvas-area">
    <div className="tp-filter-offcanvas-wrapper">
      <div className="tp-filter-offcanvas-close">
        <button type="button" className="tp-filter-offcanvas-close-btn filter-close-btn">
              ...
              <ul>
                <li>
                  <div className="tp-shop-widget-checkbox-circle">
                    ...
                    <label htmlFor="red2">Red</label>
                    <span data-bg-color="#FF401F" className="tp-shop-widget-checkbox-circle-self" />
                  </div>
                  <span className="tp-shop-widget-checkbox-circle-number">8</span>
                </li>
                <li>
                  <div className="tp-shop-widget-checkbox-circle">
                    <input type="checkbox" id="dark_blue2" />
                    <label htmlFor="dark_blue2">Dark Blue</label>
                    <span data-bg-color="#4666FF" className="tp-shop-widget-checkbox-circle-self" />
                  </div>
                  <span className="tp-shop-widget-checkbox-circle-number">14</span>
                </li>
                <li>
                  <div className="tp-shop-widget-checkbox-circle">
                    <input type="checkbox" id="oragnge2" />
                    <label htmlFor="oragnge2">Orange</label>
                    <span data-bg-color="#FF9E2C" className="tp-shop-widget-checkbox-circle-self" />
                  </div>
                  <span className="tp-shop-widget-checkbox-circle-number">18</span>
                </li>
                <li>
                  <div className="tp-shop-widget-checkbox-circle">
                    <input type="checkbox" id="purple2" />
                    <label htmlFor="purple2">Purple</label>
                    <span data-bg-color="#B615FD" className="tp-shop-widget-checkbox-circle-self" />
                  </div>
                  <span className="tp-shop-widget-checkbox-circle-number">23</span>
                </li>
                <li>
                  <div className="tp-shop-widget-checkbox-circle">
                    <input type="checkbox" id="yellow2" />
                    <label htmlFor="yellow2">Yellow</label>
                    <span data-bg-color="#FFD747" className="tp-shop-widget-checkbox-circle-self" />
                  </div>
                  <span className="tp-shop-widget-checkbox-circle-number">17</span>
                </li>
                <li>
                  <div className="tp-shop-widget-checkbox-circle">
                    <input type="checkbox" id="green2" />
                    <label htmlFor="green2">Green</label>
                    <span data-bg-color="#41CF0F" className="tp-shop-widget-checkbox-circle-self" />
                  </div>
                  <span className="tp-shop-widget-checkbox-circle-number">15</span>
                </li>
              </ul>
            </div>
          </div>
            ...
            <div className="tp-shop-main-wrapper">
              ...
              <div className="tp-shop-items-wrapper tp-shop-item-primary">
                <div className="tab-content" id="productTabContent">
                  <div  role="tabpanel" aria-labelledby="grid-tab" tabIndex={0}>
                    <div className="row">
                ...
                >
                  ...
                  <span className="tp-product-tooltip tp-product-tooltip-right">
                    Add to Cart
                                ...
                                <button onClick={() => handleAddToWishlist(product._id)} type="button" className="tp-product-action-btn-2 tp-product-add-to-wishlist-btn">
                          ...
                          <div className="tp-product-content-2 pt-15">
                            ...
                            <span style={{paddingRight:'10px'}} className="tp-product-price-2 new-price">₹{product?.currentPrice??""}</span>
                            <span className="tp-product-price-2 old-price">₹{product?.originalPrice}</span>
                            </div>
