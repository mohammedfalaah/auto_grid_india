      ...
      <div className="row row-cols-xl-5 row-cols-lg-5 row-cols-md-4 row-cols-sm-2 row-cols-2">
          ...
          <div className="tp-product-category-item text-center mb-40">
            <div className="tp-product-category-thumb fix">
              <a href="shop-category.html">
                <img style={{width:'160px'}} src="assets/img/product/cargelplates2.png" alt="product-category" />
              </a>
            </div>
        ...
        <div className="col"  style={{padding:'0px'}}>
          <div className="tp-product-category-item text-center mb-40">
            <div className="tp-product-category-thumb fix">
              <a href="shop-category.html">
                <img style={{width:'160px'}} src="assets/img/product/bikegelplate.png" alt="product-category" />
              </a>
            </div>
            <div className="tp-product-category-content">
              <h3 className="tp-product-category-title">
                <a href="shop-category.html"><strong>BIKE GEL PLATE</strong> </a>
              </h3>
            </div>
          </div>
        </div>
        <div className="col"  style={{padding:'0px'}}>
          <div className="tp-product-category-item text-center mb-40">
            <div className="tp-product-category-thumb fix">
              <a href="shop-category.html">
                <img style={{width:'160px'}}  src="/assets/img/product/iphonese.png" alt="product-category" />
              </a>
            </div>
            <div className="tp-product-category-content">
              <h3 className="tp-product-category-title">
                <a href="shop-category.html"><strong>CAR ALUMINIUM PUNCHING</strong></a>
              </h3>
            </div>
          </div>
        </div>
        <div className="col"  style={{padding:'0px'}}>
          <div className="tp-product-category-item text-center mb-40">
            <div className="tp-product-category-thumb fix">
              <a href="shop-category.html">
                <img style={{width:'160px'}} src="assets/img/product/cargelframe2.png" alt="product-category" />
              </a>
            </div>
            <div className="tp-product-category-content">
              <h3 className="tp-product-category-title">
                <a href="shop-category.html"><strong>CAR GEL FRAME</strong> </a>
              </h3>
            </div>
          </div>
        </div>
        <div className="col"  style={{padding:'0px'}}>
          <div className="tp-product-category-item text-center mb-40">
            <div className="tp-product-category-thumb fix">
              <a href="shop-category.html">
                <img style={{width:'160px'}} src="/assets/img/product/keychains2.png" alt="product-category" />
              </a>
            </div>
            <div className="tp-product-category-content">
              <h3 className="tp-product-category-title">
                <a href="shop-category.html"><strong>KEYCHAINS</strong> </a>
              </h3>
            </div>
          </div>
        </div>
        <div className="col " style={{padding:'0px'}}>
          <div className="tp-product-category-item text-center mb-40">
            <div className="tp-product-category-thumb fix">
              <a href="shop-category.html">
                <img style={{width:'160px'}} src="assets/img/product/bikeframe.png" alt="product-category" />
              </a>
            </div>
            <div className="tp-product-category-content">
              <h3 className="tp-product-category-title">
                <a href="shop-category.html"><strong>BIKE GEL FRAME</strong> </a>
              </h3>
            </div>
          </div>
        </div>
        ...
        <div className="col"  style={{padding:'0px'}}>
          <div className="tp-product-category-item text-center mb-40">
            <div className="tp-product-category-thumb fix">
              <a href="shop-category.html">
                <img style={{width:'160px'}} src="assets/img/product/keychainss.png" alt="product-category" />
              </a>
            </div>
            <div className="tp-product-category-content">
              <h3 className="tp-product-category-title">
                <a href="shop-category.html"><strong>MIRROR HANGING</strong> </a>
              </h3>
            </div>
          </div>
        </div>
      ...
      <div className="row gx-1 gy-1 gy-xl-0">
        <div className="col-xl-3 col-lg-6 col-md-6 col-sm-6">
          <div className="tp-feature-item d-flex align-items-start">
            ...
            <div className="tp-feature-content">
              <h3 className="tp-feature-title">FASTEST DELIVERY</h3>
        ...
        <div className="col-xl-3 col-lg-6 col-md-6 col-sm-6">
          <div className="tp-feature-item d-flex align-items-start">
            ...
            <div className="tp-feature-content">
              <h3 className="tp-feature-title">RETURN &amp; REFUND</h3>
