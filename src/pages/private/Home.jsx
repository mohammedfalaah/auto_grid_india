...
import { addToCartApi, productApi } from '../../services/BaseUrl';
...
/>                       </a>
                    ...
                    <div className="tp-product-action">
                      <div className="tp-product-action-item d-flex flex-column">
                        ...
                        <button onClick={() => handleAddToWishlist(product._id)} type="button" className="tp-product-action-btn tp-product-add-to-wishlist-btn">
